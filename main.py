...
class ManageHandler(BaseHandler):
    def get(self, a):
        ...
        self.render("html/Students-Management-new.html", dic=dic, Title=Club_Name, lead=lead,
                    l=self.get_permission_level() == 0)
...
class FeedBackHandler(BaseHandler):
    def get(self):
        self.write(
            "<form method=\"post\"><input type=\"text\" name=\"str\" placeholder=\" Feedback...\"><input type=\"submit\" value=\"submit\"></form>")
